...
#    cpp_nnls.solve(A, y, x1)
    ...
    diff1 = sum( (x1 - x0) * (x1 - x0) ) # comparison of c++ solver with scipy
    diff2 = sum( (x2 - x0) * (x2 - x0) ) # comparison of eigen c++ solver with scipy
...
#    print("shape(x2)= ", np.shape(x2)," x2= ", x2)
