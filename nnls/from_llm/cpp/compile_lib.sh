...
COMMAND="g++-mp-13 -O3 -g -std=c++11 -D_USE_PYBIND ${PYTHON_INC} -shared -fPIC -o my_nnls_solver.so solver.cpp -L /Users/cjknight/Documents/soft/lib/lapack/lib -llapack -lrefblas  -lpthread -lm -ldl -lgfortran ${PYTHON_LIB} "
